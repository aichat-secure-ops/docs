...
Content redaction automatically detects and hides sensitive customer information such as email addresses, phone numbers, and credit card details before messages are stored or processed. This feature is available for Enterprise tier workspaces.

<Info>
  Content Redaction is currently 
</Info>
