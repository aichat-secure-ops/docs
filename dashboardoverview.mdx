...
- **NPS Score (Net Promoter Score)**: A score that typically indicates customer loyalty where positive number closer to 100 is ideal. The analytics display the difference between the total % of users giving thumbs up 👍 minus thumbs down 👎.
