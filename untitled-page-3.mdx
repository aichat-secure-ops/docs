...
<Tabs>
  <Tab title="Microsoft Azure Entra ID OIDC">
    ...
    <img
      src="/images/Aichat-SSO-Page.png"
      alt="Aichat SSO Page"
      title="Aichat SSO Page"
      style={{ width:"50%" }}
    />
  ...
  <Tab title="Google Workspace SAML">
    ...
    <Columns cols={2}>
      <Column>
        ![Image (31)](/images/image-\(31\).png "Image (31)")
      </Column>
      <Column>
        ![Image (32)](/images/image-\(32\).png "Image (32)")
      </Column>
    </Columns>
