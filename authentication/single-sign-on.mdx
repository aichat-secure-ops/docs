...
<Tabs>
  <Tab title="Connect Microsoft Azure Entra ID ODIC">
    ...
    Before you begin, open AiChat App and the Microsoft Entra admin center in separate browser tabs. You will need to copy information between the two platforms during the setu
  </Tab>
