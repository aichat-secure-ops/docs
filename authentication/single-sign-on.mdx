...
<Tabs>
  ...
  <Tab title="Google Workspace SAML">
    ...
    sd Before you begin, open the **Google Admin console** and **AiChat Platform** in separate browser tabs. You will need to copy configuration details between the two platforms.
