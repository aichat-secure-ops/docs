...
<Note>
  Note: All users with [aichat.com](http://aichat.com) or [realpha.com](http://realpha.com) email domain are automatically whitelisted from using SSO, this is to allow us for easy access to client's org should they enable SSO
</Note>
