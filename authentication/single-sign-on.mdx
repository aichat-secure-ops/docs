...
<Steps>
  ...
  <Step title="Add AiChat redirect URL to Microsoft Entra ID">
    1. Copy the **Redirect URL** from HelpAIChat.
    2. In Microsoft Entra ID, go to Manage>**App registrations > New Registration > Authentication**.
    3. Under **Platform configurations**, click **Add a platform**.
    4. Select **Web**.
    5. Paste the HelpAIChat **Redirect URL** into the **Redirect URIs** field.
