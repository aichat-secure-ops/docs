...
<Steps>
  <Step title="Start the connection in AiChat App">
    ...
    3. In new SSO Connection, input the following
       ...
       2. Connection Type and Identify Provider: Select **OIDC**, and select **Microsoft Entra ID**
       3. Click Create new connection, and you will be asked to provide more information in the next screen, which you will get from Microsoft Entra ID.
    4. Choose **Microsoft Entra ID (OIDC)** as the Identity Provider.
    5. Enter a recognizable connection name, such as `Microsoft Entra ID`.
    6. Copy the **Redirect URI** displayed by HelpAIChat.
