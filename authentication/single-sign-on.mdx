...
<Steps>
  ...
  <Step title="Add users and test SSO">
    ...
    2. Ensure each user’s email address in AiChat matches the **Email** property in Microsoft Entra ID. HelpAIChat uses this email address to identify and match the user during SSO authentication
  </Step>
</Steps>
