...
<Steps>
  ...
  <Step title="Register AiChat in Microsoft Entra ID">
    ...
    3. Complete the application details:
       ...
       - **Supported account types:** Select **Accounts in this organizational directory only (Single tenant)** because only users from your Microsoft Entra directory will use this connection.
