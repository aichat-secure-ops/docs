...
4. Open the downloaded certificate and copy its complete contents into the **X.509 Certificate** field in AiChat
5. Return to the Google Admin console and click **Continue**.
