...
Once you have created a new flow, you will open the flow canvas. Here you will need to input a Trigger phrase to initiate the flow by clicking “Add Trigger” to initiate the trigger setup.
...
Nodes are the building blocks of a flow and they determine how the conversation will progress. There are 4 main types of Nodes you can choose.

<AccordionGroup>
  <Accordion title="Collect Node" icon="bullet">
    ...
    ![images/collectnodeattribute.png](/images/collectnodeattribute.png)

    Finally, click the "Add Message" button to customize the bot's prompts for collecting information. Here are a few examples:
    ...
    ![images/collectnodeaddmessage.png](/images/collectnodeaddmessage.png)
    ...
    \
    ![images/collectnodeaddfield.png](/images/collectnodeaddfield.png)
  </Accordion>
  <Accordion title="Branch Node" icon="bullet">
    ...
    ![images/branchnodecondition.png](/images/branchnodecondition.png)
    ...
    To activate the branch node, open the nodes option and click branch node. Then, input the conditions that users need to meet.

    ![images/branchnodesetup.png](/images/branchnodesetup.png)

    You can set more than one condition and each condition can have diverse answers based on your individual preferences.

    ![images/branchnoderesponse.png](/images/branchnoderesponse.png)
  </Accordion>
  <Accordion title="Message Node" icon="bullet">
    ...
    ![images/messagenodetext.png](/images/messagenodetext.png)
    ...
    ![images/messagenodeelements.png](/images/messagenodeelements.png)
  </Accordion>
  <Accordion title="Action Node" icon="bullet">
    ...
    **Email Action Node**
    ...
    If you need to send an email to users then email action is the one to choose. To start by clicking on “Email Action Node” in the Nodes option, then the edit panel will appear. You will need to input details of the email you want to send.

    ![images/emailactiondetail.png](/images/emailactiondetail.png)
    ...
    ![images/emailactionbody.png](/images/emailactionbody.png)
    ...
    ![images/emailactionresponse.png](/images/emailactionresponse.png)
    ...
    **HTTP Action Node**
    ...
    ![images/httpactiondetail.png](/images/httpactiondetail.png)
    ...
    ![images/httpactionapirequest.png](/images/httpactionapirequest.png)

    Once you submit the API endpoint, you can test to call the API. If it's working you can save by closing the edit panel.

    ![images/httpactiontestapi.png](/images/httpactiontestapi.png)
    ...
    ![images/apiactionresponse.png](/images/apiactionresponse.png)
  </Accordion>
</AccordionGroup>
...
In conclusion, Flow Builder is a versatile tool with the potential to enhance user engagement and streamline various business processes. By starting with simple flows and progressively incorporating more intricate interactions, users can harness the tool's capabilities effectively. 

The key to success lies in leveraging diverse steps to craft dynamic conversations, coupled with thorough testing before deployment. Whether it's customer support, sales, or marketing, Flow Builder offers a robust solution for creating tailored conversational flows that cater to a wide array of organizational needs.
