...
description: "In this step, you will manage and personalize your own bot to reflect your brand and communication style."
---
...
**How you should handle customers**: This informs how the bot should respond and guide conversations toward customer inquiries.
...
**Things you should not do**: This informs what the bot should not do when generating responses. Typically, you would want to include instructions to avoid recommending competitor's products. We have implemented guardrails to ensure the bot does not respond from its own pre-trained LLM data, which you can further fine-tune under the **Domain Strictness** section.
...
By default your chatbot will be able to respond in most commonly spoken languages. If you wish to restrict the languages, you can select the language(s) in which your bot will communicate.
...
Choose whether your bot can provide responses beyond the knowledge base that you added. There are three levels of domain strictness available:

- **Flexible** – Responds to prompts beyond its predefined knowledge scope. Choose this if you allow bots to have wider conversations between.
